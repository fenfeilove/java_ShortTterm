...
<link rel="stylesheet" type="text/css" href="../dhtmlx/dhtmlxChart/codebase/dhtmlxchart.css"/>
	...
	<script>
		var myPieChart2;
		function doOnLoad() {
			myPieChart2 = new dhtmlXChart({
				view:"pie",
				container:"chart2",
				value:"#num#",
				color:"#color#",
				label:function(obj){
					var sum = myPieChart2.sum("#num#");
					var text = Math.round(parseFloat(obj.num)/sum*100)+"%";
					return "<div>"+obj.pinzhong  +obj.num+"家<br>"+text+"</div>";
				},
				pieInnerText:"#num#",
				shadow:0,
				legend:{
			...
			myPieChart2.parse(company11,"json");
...
<div class="a"> 
   ...
   <div class="a4"> <a href="chart11.jsp">债券种类饼图</a>
	...
	<table>
		<tr>
			<td><div id="11" style="width:400px;height:100px; margin-left:600px; ">按债券品种统计</div></td>
			<td></td>
		</tr>
		<tr>
			
			<td><div id="chart2" style="width:400px;height:250px; margin-left:600px; border:1px solid #A4BED4;"></div></td>
		</tr>
	</table>
</body>
</html>
